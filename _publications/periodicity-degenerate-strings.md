---
title: Periodicity of Degenerate Strings
authors: [esteban, eric, michelle, hilde, pengfei]
link: http://www.stringology.org/papers/PSC2023.pdf#page=50
conf: Prague Stringology Conference 2023
date: 2023-08-01
...
citation: >
  Estéban Gabory, Eric Rivals, Michelle Sweering, Hilde Verbeek and Pengfei Wang. Periodicity of Degenerate Strings. In *Proceedings of the Prague Stringology Conference 2023*, pp. 42-56.
---
...
There has been a growing interest in more general models of sequences which can describe uncertainty. An important model of sequences with uncertainty are degenerate strings. A degenerate string is a string with "undetermined" symbols, which can denote arbitrary subsets of the alphabet $\Sigma$. 
Degenerate strings have been extensively used to describe uncertainty in DNA, RNA, and protein sequences using the IUPAC-encoding.
